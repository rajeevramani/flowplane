...
mod tests {
    ...
    fn test_request_builder_methods() {
        ...
        // Test that methods return RequestBuilder (this compiles = success)
        let get_req = client.get("/api/v1/clusters");
        let post_req = client.post("/api/v1/clusters");
        let put_req = client.put("/api/v1/clusters/my-cluster");
        let delete_req = client.delete("/api/v1/clusters/my-cluster");
