...
Use a published release. This example targets `3.1.3`; use it after `v3.1.3` appears on the GitHub Releases page. Its eval compose file and multi-arch eval image support the dashboard step below (`3.1.0` or newer):
