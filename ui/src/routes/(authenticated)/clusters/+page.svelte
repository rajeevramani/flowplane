<script lang="ts">
	...
	import type { ClusterResponse, ImportSummary, SessionInfoResponse } from '$lib/api/types';
...
<div class="w-full px-4 sm:px-6 lg:px-8 py-8">
	<div class="mb-8">
		...
		<p class="mt-2 text-sm text-gray-600">Platform-wide cluster summary across all organizations and teams.</p>
	</div>
	...
	{:else if $adminSummary}
		<AdminResourceSummary summary={$adminSummary} highlightResource="clusters" />
	{/if}
</div>
{:else}
<div class="w-full px-4 sm:px-6 lg:px-8 py-8">
