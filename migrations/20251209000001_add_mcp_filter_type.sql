-- Add mcp to the filter_type CHECK constraint
...
CREATE TABLE filters (
    id TEXT PRIMARY KEY,
    name TEXT NOT NULL,
    filter_type TEXT NOT NULL CHECK (filter_type IN ('header_mutation', 'jwt_auth', 'cors', 'local_rate_limit', 'rate_limit', 'ext_authz', 'custom_response', 'mcp')),
    description TEXT,
